import svgPaths from "./svg-k24gwo7gy0";
...
function Frame8() {
  return (
    <div className="absolute h-[402px] left-[31px] top-[235px] w-[342px]">
      ...
      <div className="absolute bg-[#e0e0e0] h-[190px] left-[182px] rounded-[20px] top-0 w-[160px]" data-name="CCA Card Wishlist">
        <div className="overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[9px] items-start pl-[9px] pr-[11px] py-[15px] relative size-full">
            <div className="flex-[1_0_0] min-h-px relative w-full" data-name="WF Image Placeholder">
              <div className="absolute bg-[#f2f2f2] inset-0 rounded-[10px]" data-name="WF Image Placeholder">
      ...
      <div className="absolute bg-[#e0e0e0] h-[190px] left-0 rounded-[20px] top-[212px] w-[160px]" data-name="CCA Card Wishlist">
        <div className="overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[9px] items-start pl-[9px] pr-[11px] py-[15px] relative size-full">
            <div className="flex-[1_0_0] min-h-px relative w-full" data-name="WF Image Placeholder">
              <div className="absolute bg-[#f2f2f2] inset-0 rounded-[10px]" data-name="WF Image Placeholder">
      ...
      <div className="absolute bg-[#e0e0e0] h-[190px] left-[182px] rounded-[20px] top-[212px] w-[160px]" data-name="CCA Card Wishlist">
        <div className="overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[9px] items-start pl-[9px] pr-[11px] py-[15px] relative size-full">
            <div className="flex-[1_0_0] min-h-px relative w-full" data-name="WF Image Placeholder">
              <div className="absolute bg-[#f2f2f2] inset-0 rounded-[10px]" data-name="WF Image Placeholder">
      ...
      <div className="absolute bg-[#e0e0e0] h-[190px] left-0 rounded-[20px] top-[422px] w-[160px]" data-name="CCA Card Wishlist">
        <div className="overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[9px] items-start pl-[9px] pr-[11px] py-[15px] relative size-full">
            <div className="flex-[1_0_0] min-h-px relative w-full" data-name="WF Image Placeholder">
              <div className="absolute bg-[#f2f2f2] inset-0 rounded-[10px]" data-name="WF Image Placeholder">
      ...
      <div className="absolute bg-[#e0e0e0] h-[190px] left-[182px] rounded-[20px] top-[422px] w-[160px]" data-name="CCA Card Wishlist">
        <div className="overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[9px] items-start pl-[9px] pr-[11px] py-[15px] relative size-full">
            <div className="flex-[1_0_0] min-h-px relative w-full" data-name="WF Image Placeholder">
              <div className="absolute bg-[#f2f2f2] inset-0 rounded-[10px]" data-name="WF Image Placeholder">
...
function CuidaEditOutline() {
  return (
    <div className="absolute overflow-clip right-[18px] size-[30px] top-[56px]" data-name="cuida:edit-outline">
      <Group />
    </div>
  );
}
